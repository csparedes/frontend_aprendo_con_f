...
import { User, sendCreddentials } from '../interfaces/user.interface';
...
export class UserService {
  ...
  login(credenciale: sendCreddentials): Promise<any> {
    return lastValueFrom(this.httpClient.post(this.baseUrlLogin, credenciale));
  }
